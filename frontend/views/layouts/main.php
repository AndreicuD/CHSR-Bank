...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Barlow+Condensed:wght@200;300;400;500;600&family=Fjalla+One&display=swap" rel="stylesheet">
    <?php $this->head() ?>
</head>
...
<header>
    ...
    if (Yii::$app->user->isGuest) {
        ...
        $menuItems[] = ['label' => 'My Accounts', 'url' => ['/user/accounts']];
        $menuItems[] = ['label' => 'My transactions', 'url' => ['/user/transactions']];
    }
