...
class UserController extends Controller
{
        ...
        return [
            'access' => [
                ...
                'rules' => [
                    ...
                    [
                        'actions' => ['index', 'profile', 'transactions', 'accounts', 'logout'],
                        'allow' => true,
                        'roles' => ['@'],
                    ],
                ],
    ...
    public function onAuthSuccess(ClientInterface $client)
    {
        ...
        $email = $attributes['email']; // Adjust according to the provider's response
        ...
        if ($user) {
            ...
            $user = new User();
            $user->email = $email;
            $user->username = $attributes['name']; // Adjust according to the provider's response
            $user->save();
