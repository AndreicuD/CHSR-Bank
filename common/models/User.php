 ...
 * @property string $alternative_id [varchar(36)]
 * @property string $firstname [varchar(254)]
 * @property string $lastname [varchar(254)]
 * @property string $birth_date [date]
 * @property string $cnp [varchar(14)]
 * @property string $sex [enum('F','M')]
 * @property string $address [varchar(254)]
 * @property string $email [varchar(254)]
 * @property string $phone [varchar(32)]
 * @property string $income [tinyint(2)]
 * @property string $workplace [varchar(254)]
 * @property string $estIncome [varchar(10)]
 * 
 * @property string $clientId [varchar(254)]
 * @property string $clientSecret [varchar(254)]
 * @property string $tokenUrl [varchar(254)]
 * @property string $transferUrl [varchar(254)]
 * @property string $currentIban [varchar(254)]
 * @property string $transferRecipientName [varchar(254)]
 * 
